...
import 'package:famka/config/constants/credential.dart';
import 'package:famka/services/check_for_internet.dart';
import 'package:famka/services/http_logger.dart';
  ...
  static Future<CustomHttpResult> multipart({
    ...
    try {
      ...
      HttpLogger.logRequest(
        ...
        body: {'fieldName': fieldName, if (fields != null) ...fields},
      );
